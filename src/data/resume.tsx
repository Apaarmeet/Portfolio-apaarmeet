...
export const DATA = {
  ...
  projects: [
    {
      title: "Atelier — Precision AI Software Studio",
      href: "https://atelier.apaarmeet.dev",
      dates: "2026",
      active: true,
      description:
        "An autonomous full-stack software creation engine that synthesizes, compiles, and hot-reloads React applications inside isolated E2B cloud microVMs through natural language dialogue. Features dynamic sub-1.2s Linux microVM sandbox provisioning, an infinite Vite supervisor daemon for zero-drop refactors, an autonomous function-calling LLM agent (file I/O, path normalization, shell execution), and an interactive split-pane studio with multi-device viewport toggles.",
      technologies: [
        "Next.js 16",
        "React 19",
        "Tailwind CSS v4",
    ...
    {
      title: "Pind Ton Highway (ਪਿੰਡ ਤੋਂ ਹਾਈਵੇ) — Digital Trucker Radio",
      href: "https://pind-ton-highway.vercel.app/",
      dates: "2026",
      active: true,
      description:
        "An atmospheric digital Punjabi trucker radio capturing late-night GT Road highway drives paired with classic Punjabi anthems. Features a headless YouTube audio engine wrapped in a vintage vinyl/cassette player with Punjabi truck-art aesthetics, real-time listener sync via Pusher presence channels, and interactive multi-sensory horn vibrations.",
      technologies: [
        "Next.js 16",
        "React 19",
        "TypeScript",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/apaarmeet/pind-ton-highway",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/pind-ton-highway.png",
      video: "",
    },
    {
